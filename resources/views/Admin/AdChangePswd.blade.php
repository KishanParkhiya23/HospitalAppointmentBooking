    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-7">
            <div class="card p-3 py-4">
                ...
                <form action="{{route('AdChangePswdSave')}}" method="POST">
                    @csrf
                    <div class="text-center mt-3">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="password" class="form-control my-2" name="RNPswd" placeholder="Re-Enter Password">
                                <p class="float-right"><a href="{{route('AdForgetPswd')}}" class="text-info d-block my-2" style="font-size:.9rem">Forget Password</a></p>
                            </div>
                            <div class="col-md-2"></div>
                        </div>

                        <div class="buttons">
                            <a href="{{route('AdEdit',$data->id)}}" class="btn btn-outline-info px-4">
                                Cancle
                            </a>
